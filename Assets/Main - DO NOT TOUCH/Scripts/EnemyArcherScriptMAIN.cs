...
public class EnemyArcherScriptMAIN : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(bigArcher)
        {
            attackAnimName = "archattackSECOND";
        }
        else
        {
            attackAnimName = "archattack";
        }
    }
    ...
    private void StopEnemy()
    {
        ...
        archerAnim.SetBool("Chasing", false);
    }
    ...
    private void GoToTarget()
    {
        ...
        archerAnim.SetBool("Chasing", true);
    }
    ...
    IEnumerator AttackTimer()
    {
        ...
        while (attackWindUp && flashAmount < 3f)
        {
            ...
            if (SafetySwitch > SAFETYLIMIT) { Debug.Log("UNSAFEWHILELOOP ARCHER 181"); break; }
            }
        ...
        flashAmount = 0;
        spriteRendererRef.color = Color.white;
        archerAnim.SetBool("Attacking", true);
        archerAnim.Play(attackAnimName);
        var attackLength =  archerAnim.GetCurrentAnimatorStateInfo(0).length;
    ...
    private void RangedAttack()
    {
        ...
        archerAnim.SetBool("Attacking", false);
    }
}
